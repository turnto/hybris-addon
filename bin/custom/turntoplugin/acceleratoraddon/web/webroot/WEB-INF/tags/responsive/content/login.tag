...
<div class="description">
	<div class="headline">
		...
		<%--<p>If you don't have an account, <a href="<c:url value='/abt_car_wash_form_request_account'/>">click here</a> to request an account.</p>--%>
	</div>
...
<form:form action="${action}" method="post" commandName="loginForm">
	...
	<div class="forgotten-password">
		<ycommerce:testId code="login_forgotPassword_link">
			...
			<%--<a href="<c:url value='/login/pw/request'/>" class="js-password-forgotten not-active " data-cbox-title="<spring:theme code="forgottenPwd.title"/>">--%>
