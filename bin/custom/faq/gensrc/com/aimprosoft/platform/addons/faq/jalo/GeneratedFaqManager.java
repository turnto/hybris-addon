...
import com.aimprosoft.platform.addons.faq.jalo.RandomImageParagraphComponent;
...
/**
 * Generated class for type <code>FaqManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedFaqManager extends Extension
{
	...
	public RandomImageParagraphComponent createRandomImageParagraphComponent(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( FaqConstants.TC.RANDOMIMAGEPARAGRAPHCOMPONENT );
	...
	{
		return FaqConstants.EXTENSIONNAME;
	}
