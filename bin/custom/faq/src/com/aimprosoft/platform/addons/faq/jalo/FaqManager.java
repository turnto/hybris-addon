...
import com.aimprosoft.platform.addons.faq.constants.FaqConstants;



/**
 * This is the extension manager of the Faq extension.
 */
public class FaqManager extends GeneratedFaqManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FaqManager.class.getName());
	...
	{
		return (FaqManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FaqConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FaqManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FaqManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FaqManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FaqManager called, current tenant: " + getTenant().getTenantID());
		}
	}
