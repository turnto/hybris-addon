 ...
 *
 */
package com.aimprosoft.platform.addons.faq.hmc;
...
/**
 * Provides necessary meta information about the faq hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.4
 */
public class FaqHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(FaqHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.aimprosoft.platform.addons.faq.hmc.locales";
