 ...
 *
 */
package com.aimprosoft.platform.addons.qanda.jalo;
...
import com.aimprosoft.platform.addons.qanda.constants.QandaConstants;



/**
 * This is the extension manager of the Qanda extension.
 */
public class QandaManager extends GeneratedQandaManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(QandaManager.class.getName());
	...
	{
		return (QandaManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				QandaConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public QandaManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of QandaManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of QandaManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of QandaManager called, current tenant: " + getTenant().getTenantID());
		}
	}
