 ...
 *
 */
package com.aimprosoft.platform.addons.qanda.hmc;
...
/**
 * Provides necessary meta information about the qanda hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.4
 */
public class QandaHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(QandaHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.aimprosoft.platform.addons.qanda.hmc.locales";
