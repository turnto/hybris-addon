 ...
 *  
 */
package com.aimprosoft.platform.productfeed.jalo;
...
import com.aimprosoft.platform.productfeed.constants.ProductfeedConstants;



/**
 * This is the extension manager of the Productfeed extension.
 */
public class ProductfeedManager extends GeneratedProductfeedManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductfeedManager.class.getName());
	 ...
	 */
	public static ProductfeedManager getInstance()
	{
		return (ProductfeedManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductfeedConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductfeedManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductfeedManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductfeedManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductfeedManager called, current tenant: " + getTenant().getTenantID());
		}
	}
